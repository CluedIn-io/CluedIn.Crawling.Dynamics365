...
{
    public class CustomerAddressClueProducer : DynamicsClueProducer<CustomerAddress>
    {
        ...
        public override Clue CreateClue(CustomerAddress input, Guid accountId)
        {
            return _factory.Create(EntityType.Location.Address, input.CustomerAddressId.ToString(), accountId);
        }

        public override void Customize(Clue clue, CustomerAddress input)
        {
