...
namespace CluedIn.Crawling.Dynamics365.Core
{
    public class Dynamics365CrawlJobData : CrawlJobData
    {
        ...
        public Dynamics365CrawlJobData(IDictionary<string, object> configuration)
        {
            ...
            ClientId = configuration.GetValue(Dynamics365Constants.KeyName.ClientId, ConfigurationManager.AppSettings.GetValue<string>("Providers.Dynamics365ClientId", null));
            ClientSecret = configuration.GetValue(Dynamics365Constants.KeyName.ClientSecret, ConfigurationManager.AppSettings.GetValue<string>("Providers.Dynamics365ClientSecret", null));
